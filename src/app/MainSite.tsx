  ...
  return (
    <div className="min-h-screen bg-[#dde2df]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      {!isLoadingData && (
        <button
          onClick={reloadData}
          className="fixed bottom-6 right-6 bg-[#7f9f5f] text-white px-4 py-2 rounded-full shadow-lg hover:bg-[#6a8850] transition-colors z-40 text-sm font-medium flex items-center gap-2"
